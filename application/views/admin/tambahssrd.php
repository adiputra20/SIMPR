                    ...
                    <div class="card shadow mb-4" style="width: 100%">
                        ...
                        <div class="card-body">
                            <?php foreach ($skrd as $data) : ?>
                                <form method="POST" action="<?php echo base_url('admin/ssrd/addDataAct'); ?>" class="needs-validation" novalidate>
                                    ...
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="form-group col-md-2">
                                            <input type="text" class="form-control form-control-sm" readonly id="nomor" name="nomor" placeholder="No. SKRD" value="<?php echo $data->skrd; ?>">
                                    ...
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="form-group col-md-2">
                                            <input type="text" class="form-control form-control-sm" id="sspd" name="sspd" required>
                                            <div class="invalid-feedback">No. SSRD Wajib Diisi!!!!!</div>
                                        </div>
                                    ...
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="form-group col-md-10">
                                            <textarea class="form-control form-control-sm" name="keterangan" id="keterangan" rows="3" required></textarea>
                                    ...
                                    <a class="btn btn-sm btn-danger btn-icon-split" href="<?php echo base_url('admin/ssrd') ?>"><span class="icon text-white-50"><i class="fas fa-times"></i></span><span class="text">&nbsp Batal &nbsp</span></a>
                                </form>
                            <?php endforeach; ?>
                        </div>
                    </div>
