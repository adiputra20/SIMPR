                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4" style="width: 100%">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?php echo base_url('admin/daftarp/addDataAct'); ?>" class="needs-validation" novalidate>
                                <div class="form-group row mb-0">
                                    <label for="npwpd" class="col-md-2 col-form-label col-form-label-sm">NPWPD</label>
                                    <div class="form-group col-md-3">
                                        <input type="text" class="form-control form-control-sm" id="npwpd" name="npwpd" placeholder="NPWPD" required>
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="invalid-feedback">Nama/Merk Usaha Wajib Diisi Diisi!!!!!</div>
                                    </div>
