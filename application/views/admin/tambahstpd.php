                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4" style="width: 100%">
                        ...
                        <div class="card-body">
                            <?php foreach ($stpd as $data) :  ?>
                                <form method="POST" action="<?php if (is_null($data->nostpd)) {
                                                                echo base_url('admin/stpd/addDataAct');
                                                            } else {
                                                                echo base_url('admin/stpd/editDataAct');
                                    ...
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="form-group col-md-4">
                                            <input type="text" class="form-control form-control-sm" id="nostpd" name="nostpd" placeholder="No. STPD/Teguran" <?php if (!is_null($data->nostpd)) { ?> readonly value="<?php echo $data->nostpd; ?>" <?php }; ?> required>
                                            <div class="invalid-feedback">Nomor STPD/Teguran Wajib Diisi!!!!!</div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-0">
                                    ...
                                    <a class="btn btn-sm btn-danger btn-icon-split" href="<?php echo base_url('admin/stpd') ?>"><span class="icon text-white-50"><i class="fas fa-times"></i></span><span class="text">&nbsp Batal &nbsp</span></a>
                                </form>
                            <?php endforeach ?>
                        </div>
                    </div>
