                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4" style="width: 100%">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-secondary"><?php echo 'Edit ' . $title . ' Nomor ' . $nosspd; ?></h6>
                        </div>
                        <div class="card-body">
                            <?php foreach ($sspd as $data) : ?>
                                <form method="POST" action="<?php echo base_url('admin/ssrd/editDataAct'); ?>" class="needs-validation" novalidate>
                                    ...
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="form-group col-md-2">
                                            <input type="text" class="form-control form-control-sm" readonly id="nomor" name="nomor" placeholder="No. SKPD" value="<?php echo $data->skrd; ?>">
                                    ...
                                    <div class="form-group row mb-0">
                                        <label for="tanggal1" class="col-md-2 col-form-label col-form-label-sm">No. SSRD</label>
                                        <div class="form-group col-md-2">
                                            <input type="text" class="form-control form-control-sm" id="sspd" readonly name="sspd" value="<?php echo $data->ssrd; ?>" required>
                                    ...
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="form-group col-md-2">
                                            <input type="text" class="form-control form-control-sm text-right" id="setoran" name="setoran" placeholder="Nilai Setoran" value="<?php echo $data->nilai; ?>" required>
                                    ...
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="form-group col-md-10">
                                            <textarea class="form-control form-control-sm" name="keterangan" id="keterangan" rows="3" required><?php echo $data->keterangan; ?></textarea>
                                    ...
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="form-group col-md-2">
                                            <select class="form-control form-control-sm mr-sm-2" id="nm_rek" name="nm_rek" required>
                                                <option <?php if (is_null($data->nmrek)) {
                                                            echo "selected";
                                                        }; ?> disabled value="">Pilih Rekening...</option>
                                                <?php foreach ($akun as $rek) : ?>
                                                    <option <?php if ($data->nmrek == $rek->nmrek) {
                                                                echo "selected";
                                    ...
                                    <a class="btn btn-sm btn-danger btn-icon-split" href="<?php echo base_url('admin/ssrd/infoData/' . base64_encode($data->skrd)) ?>"><span class="icon text-white-50"><i class="fas fa-times"></i></span><span class="text">&nbsp Batal &nbsp</span></a>
                                </form>
                            <?php endforeach; ?>
                        </div>
                    </div>
