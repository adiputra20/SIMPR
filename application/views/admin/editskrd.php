                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4" style="width: 100%">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-secondary"><?php foreach ($skrd as $judul) : if (is_null($judul->penetapan)) {
                                                                                    echo 'Tambah ' . $title;
                                                                                } else {
                                                                                    echo 'Edit ' . $title;
                                                                                };
                        ...
                        <div class="card-body">
                            <?php foreach ($skrd as $data) : ?>
                                <form method="POST" action="<?php echo base_url('admin/skrd/editDataAct'); ?>">
                                    <div class="form-group row mb-0">
                                        <label for="npwpd" class="col-md-2 col-form-label col-form-label-sm">NPWRD</label>
                                        <div class="form-group col-md-2">
                                            <input type="text" class="form-control form-control-sm" readonly id="npwpd" name="npwpd" placeholder="NPWPD" value="<?php echo $data->npwrd; ?>">
                                    ...
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="form-group col-md-4">
                                            <input type="text" class="form-control form-control-sm" id="nomor" name="nomor" placeholder="No. SKPD" value="<?php echo $data->skrd; ?>">
                                            <input type="hidden" name="nomorlama" value="<?php echo $data->skrd; ?>">
