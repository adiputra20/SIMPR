                    ...
                    <div class="card shadow mb-4" style="width: 100%">
                        ...
                        <div class="card-body">
                            <?php foreach ($sspd as $data) : ?>
                                <form method="POST" action="<?php echo base_url('admin/sspd/editDataAct'); ?>" class="needs-validation" novalidate>
                                    ...
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="form-group col-md-2">
                                            <input type="text" class="form-control form-control-sm" id="sspd" readonly name="sspd" value="<?php echo $data->sspd; ?>" required>
                                    ...
                                    <a class="btn btn-sm btn-danger btn-icon-split" href="<?php echo base_url('admin/sspd/infoData/' . base64_encode($data->skpd)) ?>"><span class="icon text-white-50"><i class="fas fa-times"></i></span><span class="text">&nbsp Batal &nbsp</span></a>
                                </form>
                            <?php endforeach; ?>
                        </div>
                    </div>
