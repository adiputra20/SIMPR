                    ...
                    <div class="form-group mb-0">
                        ...
                        <!-- <select name="obyek" id="obyek" class="form-control form-control-sm sm mb-2 mr-sm-2" required>
                                        ...
                                        <?php foreach ($rek as $kode) : ?>
                                            <option value="<?php echo $kode->obyek; ?>"><?php echo $kode->obyek; ?></option>
                                        <?php endforeach; ?>
                                    </select> -->
                        ...
                        <a href="<?php echo base_url('admin/bku/printData/?tanggalAwal=' . $_GET['tanggalAwal'] . '&tanggalAkhir=' . $_GET['tanggalAkhir']); ?>" target="_blank" class="btn btn-sm btn-success btn-icon-split mb-2 mr-sm-2"><span class="icon text-white-50"><i class="fas fa-print"></i></span><span class="text">&nbsp;&nbsp;&nbsp;&nbsp;Cetak&nbsp;&nbsp;&nbsp;&nbsp;</span></a>
                    </div>
                </form>
            </div> <!-- /.Card Body -->
        </div> <!-- Card -->
        <div class="alert alert-sm alert-info">
            Menampilkan Buku Kas Penerimaan <span class="font-weight-bold"><?php echo $keterangan; ?></span>
        </div>
        <table class="table table-bordered table-hover table-sm" cellspacing="0" width="100%" id="example">
            ...
            <tbody>
                ...
                foreach ($bukubesar as $data) : $saldo += $data->nilai; ?>
                    <tr>
                        ...
                        <td class="text-right" width="10%"><?php echo number_format($data->nilai, 2, '.', ','); ?></td>
            ...
            <tfoot>
                <tr class="font-weight-bold">
                    ...
                    <td class="text-right" width="10%"><?php echo number_format($saldo, 2, '.', ','); ?></td>
                    <td class="text-right" width="10%"><?php echo '0'; ?></td>
                </tr>
            </tfoot>
        </table>
