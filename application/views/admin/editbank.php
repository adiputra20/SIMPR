                    ...
                    <div class="card shadow mb-4" style="width: 80%"> 
                        ...
                        <div class="card-body">
                            <?php foreach ($rek as $bank): ?>
                                <form method="POST" action="<?php echo base_url('admin/bank/editDataAct'); ?>" class="needs-validation" novalidate>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label col-form-label-sm">No. Rekening</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="no_rek" readonly class="form-control form-control-sm" placeholder="No. Rekening" value="<?php echo $bank->norek;?>" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="nm_rek" class="form-control form-control-sm" placeholder="Nama Rekening" value="<?php echo $bank->nmrek; ?>"required>
                                ...
                                <a href="<?php echo base_url('admin/bank') ?>" class="btn btn-sm btn-danger btn-icon-split"><span class="icon text-white-50"><i class="fas fa-times"></i></span><span class="text">&nbsp Batal &nbsp</span></a>
                            </form>
                            <?php endforeach; ?>
                        </div>
                </div>
