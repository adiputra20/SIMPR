                    ...
                    <div class="card shadow mb-4" style="width: 100%">
                        ...
                        <div class="card-body">
                            <?php foreach ($wp as $wp) : ?>
                                <form method="POST" action="<?php echo base_url('admin/daftarp/editDataAct'); ?>" class="needs-validation" novalidate>
                                    <div class="form-group row mb-0">
                                        <label for="npwpd" class="col-md-2 col-form-label col-form-label-sm">NPWPD</label>
                                        <div class="form-group col-md-3">
                                            <input type="text" readonly class="form-control form-control-sm" id="npwpd" name="npwpd" placeholder="NPWPD" value="<?php echo $wp->npwprd; ?>" required>
                                    ...
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="form-group col-md-10">
                                            ...
                                            <div class="invalid-feedback">Nama/Merk Wajib Diisi!!!!!</div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-0">
                                    ...
                                    <a class="btn btn-sm btn-danger btn-icon-split" href="<?php echo base_url('admin/daftarp') ?>"><span class="icon text-white-50"><i class="fas fa-times"></i></span><span class="text">&nbsp Batal &nbsp</span></a>
                                </form>
                        </div>
                    </div>
                <?php endforeach; ?>
