                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4" style="width: 80%"> 
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?php echo base_url('admin/bidang/addDataAct'); ?>" class="needs-validation" novalidate>
                                <div class="form-group">
                                    <label class="col-form-label col-form-label-sm">Nama Bidang</label>
                                    <input type="text" name="bidang" class="form-control form-control-sm" placeholder="Nama Bidang Dinas/Badan" required>
                                    <div class="invalid-feedback">Nama Bidang Wajib Diisi!!!!!</div>
                                </div>
