    ...
    <?php foreach ($skpd as $data) : ?>
        <table border="1" cellspacing="0" width="100%">
            <tr>
                ...
                <td width="70%">
                    ...
                    <h1 class="h5 mb-0 text-gray-800 font-weight-bold ml-3 text-center"><b>SKPD</b></h1>
                    <h1 class="h5 mb-0 text-gray-800 font-weight-bold ml-3 text-center"><b>(SURAT KETETAPAN PAJAK DAERAH)</b></h1>
                    <hr color="black">
                    <form action="form-inline">
                        <div class="form-group row mb-1">
                            <label class="col-sm-2 col-form-label ml-4 text-gray-900">Masa Pajak</label>
                            <div class="col-sm-5">
                        ...
                        <div class="form-group row mb-1">
                            <label for="staticEmail" class="col-sm-2 col-form-label ml-4 text-gray-900">Tahun Pajak</label>
                            <div class="col-sm-6">
        ...
        <table width="100%" cellspacing="0" border="1">
            <tr>
                <td>
                    <div class="form-group row mb-1">
                        <label class="col-sm-3 col-form-label ml-4 text-gray-900">NPWPD</label>
                        <div class="col-sm-6 ml-0">
                            <input type="text" readonly class="form-control-plaintext text-gray-900" value=": <?php echo $data->npwpd; ?> ">
                        </div>
                    </div>
                    <div class="form-group row mb-1">
        ...
        <table width="100%" cellspacing="0" border="1">
            <tr>
                ...
                <td width="30%" class="text-center text-gray-900" colspan="6">KODE REKENING</td>
                ...
                <tr>
                    <td>
                        <div class="form-group row text-gray-900">
                            ...
                            <label for="inputEmail3" class="col-sm-2 col-form-label"></label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control-plaintext text-gray-900 text-center font-weight-bold" value="No. SKRD : <?php echo $data->skpd; ?>">
                            </div>
                        </div>
                        &nbsp;&nbsp;&nbsp;NPWRD &nbsp;:&nbsp;<?php echo $data->npwpd; ?><br>
