                    ...
                    <table color="black" class="table table-bordered table-sm" id="dataTable" width="100%" cellspacing="0">
                        <thead>
                            <tr class="text-bold text-gray-900">
                                ...
                                <th class="text-center" width="9%">NPWPD</th>
                                <th class="text-center">Nama/Merk Usaha</th>
                                <th class="text-center">Obyek Pajak</th>
                                <th class="text-center" width="9%">Penetapan</th>
                                <th class="text-center" width="9%">Jatuh Tempo</th>
                                <th class="text-center" width="12%">Ketetapan</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $total=0; foreach($skrd as $wp): $total+=$wp->ketetapan; ?>
                                <tr class="text-gray-900">
                                    <td><?php echo $wp->skrd; ?></td>
                                    <td><?php echo $wp->npwrd; ?></td>
                                    <td><?php echo $wp->namausaha; ?></td>
                                    <td><?php echo $wp->obyek; ?></td>
                                    <td><?php echo date("d-m-Y",strtotime($wp->penetapan)); ?></td>
