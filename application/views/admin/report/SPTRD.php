        ...
        <?php foreach($wajibp as $data): ?>
            <table border="1" cellspacing="0" width="100%">
                <tr>
                    ...
                    <td width="70%">
                        ...
                        <h1 class="h5 mb-0 text-gray-800 font-weight-bold ml-3 text-center"><b>SPTRD</b></h1>
                        <h1 class="h5 mb-0 text-gray-800 font-weight-bold ml-3 text-center"><b>(SURAT PEMBERITAHUAN RETRIBUSI DAERAH)</b></h1>
                    </td>
                    <td class="text-center">
                        <small class="font-weight-bold text-gray-900"> Lembar 1<br>Untuk Wajib Retribusi</small>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td>
                        ...
                        <div class="form-group row mb-0 ml-2">
                            ...
                            <label class="col-sm-3 col-form-label text-gray-900">1. Nama Wajib Retribus</label>
                        ...
                        <div class="form-group row mb-0 ml-2">
                            ...
                            <label class="col-sm-3 col-form-label text-gray-900">2. Alamat Wajib Retribusi</label>
                            <div class="col-sm-6 ml-0">
                ...
                <tr>
                    <td>
                        <div class="form-group row mb-0 ml-2">
                            ...
                            <label class="col-sm-3 col-form-label text-gray-900">1. NPWRD)*</label>
                            <div class="col-sm-6 ml-0">
                        ...
                        <div class="form-group row mb-0 ml-2">
                            ...
                            <label class="col-sm-3 col-form-label text-gray-900">Penghitungan Retribusi Daerah</label>
                        </div>
                    </td>
                </tr>
            </table>
            <table border="1" width="100%" cellspacing="0" class="text-gray-900">
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <?php if($data->jenisusaha=="Kios"){ $total += 2184000; ?>
                           Rp. 2.184.000,-&nbsp;&nbsp;
                        <?php }; ?>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pemakaian Kekayaan Daerah</td>
                    <td class="text-center">
                        <?php if($data->jenisusaha=="Sewa Aset"){ ?>
                           12 Bulan 
                        <?php }; ?>
                    </td>
                    <td class="text-right">
                    ...
                    <td class="text-right">
                        <?php if($data->jenisusaha=="Sewa Aset"){ $total += 2184000; ?>
                            Rp. 2.184.000,-&nbsp;&nbsp;
                        <?php }; ?>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pemakaian Rumah Dinas Eselon II</td>
                    <td class="text-center">
                        <?php if($data->jenisusaha=="Rumah Dinas Eselon II"){ ?>
                           12 Bulan 
                        <?php }; ?>
                    </td>
                    <td class="text-right">
                    ...
                    <td class="text-right">
                        <?php if($data->jenisusaha=="Rumah Dinas Eselon II"){ $total += 2400000; ?>
                            Rp. 2.400.000,-&nbsp;&nbsp;
                        <?php }; ?>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pemakaian Rumah Dinas Eselon III</td>
                    <td class="text-center">
                        <?php if($data->jenisusaha=="Rumah Dinas Eselon III"){ ?>
                           12 Bulan 
                        <?php }; ?>
                    </td>
                    <td class="text-right">
                    ...
                    <td class="text-right">
                        <?php if($data->jenisusaha=="Rumah Dinas Eselon III"){ $total += 2100000; ?>
                            Rp. 2.100.000,-&nbsp;&nbsp;
                        <?php }; ?>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pemakaian Rumah Dinas Eselon IV</td>
                    <td class="text-center">
                        <?php if($data->jenisusaha=="Rumah Dinas Eselon IV"){ ?>
                           12 Bulan 
                        <?php }; ?>
                    </td>
                    <td class="text-right">
                    ...
                    <td class="text-right">
                        <?php if($data->jenisusaha=="Rumah Dinas Eselon IV"){ $total += 1800000; ?>
                            Rp. 1.800.000,-&nbsp;&nbsp; 
                        <?php }; ?>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pemakaian Rumah Dinas Staf</td>
                    <td class="text-center">
                        <?php if($data->jenisusaha=="Rumah Dinas Eselon Staf"){ ?>
                           12 Bulan 
                        <?php }; ?>
                    </td>
                    <td class="text-right">
                    ...
                    <td class="text-right">
                        <?php if($data->jenisusaha=="Rumah Dinas Eselon Staf"){ $total += 1200000; ?>
                            Rp. 1.200.000,-&nbsp;&nbsp;  
                        <?php }; ?>
                    </td>
                </tr>
