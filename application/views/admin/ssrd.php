                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <!-- <a class="btn btn-sm btn-primary mb-1 btn-icon-split" href="<?php echo base_url('admin/ssrd/printRegister/'); ?>"><span class="icon text-white-50"><i class="fas fa-print"></i></span><span class="text">Register</span></a> -->
                                        ...
                                        <tbody>
                                            <?php foreach ($skrd as $wp) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center>
                                                            <a class="btn btn-sm btn-circle btn-primary" data-toggle="tooltip" data-placement="top" title="tambah SSRD" href="<?php echo base_url('admin/ssrd/addData/' . base64_encode($wp->npwprd)); ?>">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                            <?php if ($wp->nilai != 0) { ?>
                                                                <a class="btn btn-sm btn-circle btn-success" data-toggle="tooltip" data-placement="top" title="detail SSRD" href="<?php echo base_url('admin/ssrd/infoData/' . base64_encode($wp->skrd)); ?>">
                                                            ...
                                                            <?php }; ?>
                                                            <a class="btn btn-sm btn-circle <?php if ($wp->ketetapan - $wp->nilai != 0) {
                                                                                                echo "btn-warning";
                                                                                            } else {
                                                                                                echo "btn-primary";
                                                                                                                                                        ...
                                                                                                                                                        echo "LUNAS";
                                                                                                                                                                    ...
                                                                                                                                                                    echo base_url('admin/ssrd/printBlanko/' . str_replace("/", "_", $wp->skrd));
                                                                                                                                                                } else {
                                                                                                                                                                    echo '#';
                                                                                                                                                                } ?>">
