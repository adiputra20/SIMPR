                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4" style="width: 100%">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-secondary"><?php foreach ($skpd as $judul) : if (is_null($judul->penetapan) || strlen(trim($judul->skpd)) <= 0) {
                                                                                    echo 'Tambah ' . $title;
                                                                                } else {
                                                                                    echo 'Edit ' . $title;
                                                                                };
                        ...
                        <div class="card-body">
                            <?php foreach ($skpd as $data) : ?>
                                <form method="POST" action="<?php echo base_url('admin/skpd/addDataAct'); ?>" class="needs-validation" novalidate>
                                    ...
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="form-group col-md-4">
                                            <input type="text" class="form-control form-control-sm" id="nomor" name="nomor" placeholder="No. SKPD" value="<?php echo $data->skpd; ?>" required>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <div class="invalid-feedback">Tahun Pajak Wajib Diisi!!!!!</div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-0">
                                    ...
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <div class="invalid-feedback">Nilai Per Bulan Wajib Diisi!!!!!</div>
                                        </div>
                                    ...
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <div class="invalid-feedback">Tanggal Input Denda Wajib Diisi!!!!!</div>
                                        </div>
                                    </div>
