                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a class="btn btn-sm btn-info mb-1 btn-icon-split ml-auto" href="<?php echo base_url('admin/lra/printData/'); ?>" target="_blank"><span class="icon text-white-50"><i class="fas fa-print"></i></span><span class="text"><?php echo $title; ?></span></a>
                        </div>
                        <div class="card-body">
                            <small>
                                    ...
                                    <table class="table table-bordered table-hover" id="example" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center"width="9%">Anggaran</th>
