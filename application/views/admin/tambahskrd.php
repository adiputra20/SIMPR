                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4" style="width: 100%">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-secondary"><?php foreach ($skrd as $judul) : if (is_null($judul->penetapan) || strlen(trim($judul->skrd)) <= 0) {
                                                                                    echo 'Tambah ' . $title;
                                                                                } else {
                                                                                    echo 'Edit ' . $title;
                                                                                };
                        ...
                        <div class="card-body">
                            <?php foreach ($skrd as $data) : ?>
                                <form method="POST" action="<?php echo base_url('admin/skrd/addDataAct'); ?>" class="needs-validation" novalidate>
                                    <div class="form-group row mb-0">
                                        <label for="npwpd" class="col-md-2 col-form-label col-form-label-sm">NPWRD</label>
                                        <div class="form-group col-md-2">
                                            <input type="text" class="form-control form-control-sm" readonly id="npwpd" name="npwpd" placeholder="NPWPD" value="<?php echo $data->npwrd; ?>" required>
                                            <div class="invalid-feedback">NPWPD Wajib Diisi!!!!!</div>
                                        </div>
                                        <div class="form-group col-md-8">
                                            <input type="text" class="form-control form-control-sm" readonly id="nama" name="nama" placeholder="Nama/Merk Usaha" value="<?php echo $data->namapemilik . ' / ' . $data->namausaha; ?>" required>
                                            <div class="invalid-feedback">Nama Wajib Diisi!!!!!</div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-0">
                                        <label for="nomor" class="col-md-2 col-form-label col-form-label-sm">No. SKRD</label>
                                        <div class="form-group col-md-4">
                                            <input type="text" class="form-control form-control-sm" id="nomor" name="nomor" placeholder="No. SKRD" value="<?php echo $data->skrd; ?>" required>
                                            <div class="invalid-feedback">No. SKRD Wajib Diisi!!!!!</div>
                                        </div>
                                        <!-- <label for="tahun" class="col-md-2 col-form-label">Tahun</label> -->
                                        <div class="form-group col-md-2">
                                            <input type="text" class="form-control form-control-sm" readonly id="tahun" name="tahun" placeholder="Tahun" value="<?php echo $data->tahun; ?>" required>
                                    ...
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <div class="invalid-feedback">Tg. Jatuh Tempo Wajib Diisi!!!!!</div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="form-group col-md-6 search_select_box">
                                            ...
                                            <div class="invalid-feedback">Obyek Retribusi Wajib Diisi!!!!!</div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-0">
                                    ...
                                    <a class="btn btn-sm btn-danger btn-icon-split" href="<?php echo base_url('admin/skrd') ?>"><span class="icon text-white-50"><i class="fas fa-times"></i></span><span class="text">&nbsp Batal &nbsp</span></a>
                                </form>
                            <?php endforeach; ?>
                        </div>
                    </div>
