                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4" style="width: 100%">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?php echo base_url('admin/nsts/addDataAct'); ?>" class="needs-validation" novalidate>
                                <div class="form-group row mb-0">
                                    <label for="npwpd" class="col-md-2 col-form-label col-form-label-sm">No. STS</label>
                                    <div class="form-group col-md-3">
                                        <input type="text" class="form-control form-control-sm" id="no_sts" name="no_sts" placeholder="Nomor STS" required>
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="form-group col-md-9">
                                        <select class="form-control form-control-sm mr-sm-2 selectpicker" data-live-search="true" id="nmobyek" name="nmobyek" required>
                                            <option selected disabled value="">Pilih Obyek Rekening...</option>
                                            <?php foreach ($obyek as $akun) : ?>
                                                <option value="<?php echo $akun->namalra; ?>"><?php echo $akun->namalra; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="form-group col-md-2">
                                        <input type="text" class="form-control form-control-sm" id="nilai" name="nilai" placeholder="Nilai" required>
