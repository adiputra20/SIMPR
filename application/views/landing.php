...
<body id="home">
        ...
        <div class="container px-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link text-uppercase active" aria-current="page" href="#home"><i class="fa-solid fa-house"></i> Home</a></li>
    ...
    <div class="container px-4 px-lg-5" id="struktur-organisasi">
        <div class="card mb-5">
            ...
            <div class="card-body">
                <div id="left">
                    <ul id="organisation" style="display:none">
                        <li>
                            <adjunct>Sekretaris</adjunct><em>Kepala Badan</em>
                            <ul>
                                <li>Kabid Pajak
                                    <ul>
                                        <li>Seksi Pendaftaran dan Pendataan</li>
                                        <li>Seksi Pemeriksaan</li>
                                        <li>Seksi Penetapan</li>
                                    </ul>
                                </li>
                                <li>Kabid Retribusi
                                    <ul>
                                        <li>Seksi Pembukuan dan Pemeriksaan</li>
                                        <li>Seksi Pemeriksaan</li>
                                        <li>Seksi Pembukuan dan Pelaporan</li>
                                    </ul>
                                </li>
                                <li>Kabid Penagihan & Keberatan
                                    <ul>
                                        <li>Seksi Penagihan</li>
                                        <li>Seksi Keberatan</li>
                                ...
                                <li>Kabid PPHTB
                                    <ul>
                                        <li>Seksi Pendaftaran dan Pendataan</li>
                                        <li>Seksi Penagihan dan Penerimaan</li>
                                        <li>Seksi Verifikasi dan Keberatan</li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
    ...
    <footer class="py-2 bg-secondary">
        <div class="container px-4 px-lg-5">
            <p class="m-0 text-center text-white">Copyright &copy; Antonius Vicky Prayoga, ST., M.AK. - 2022</p>
        </div>
    </footer>
